...
import com.pengkey.security.domain.UserLoginExample.Criteria;
import com.pengkey.security.domain.UserLoginExample.Criterion;
...
public class UserLoginSqlProvider {
    ...
    public String countByExample(UserLoginExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("user_login");
    ...
    public String deleteByExample(UserLoginExample example) {
        BEGIN();
        DELETE_FROM("user_login");
        applyWhere(example, false);
        return SQL();
    }
    ...
    public String selectByExample(UserLoginExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        UserLogin record = (UserLogin) parameter.get("record");
        UserLoginExample example = (UserLoginExample) parameter.get("example");
    ...
    protected void applyWhere(UserLoginExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
